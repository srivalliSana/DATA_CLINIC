...
<div className="absolute -inset-0.5 rounded-2xl bg-[var(--color-primary)]/20 opacity-0 transition duration-500 group-hover/upload:opacity-75 group-hover/upload:blur"></div>
                ...
                {error && (
                    <div className="bg-red-50 dark:bg-red-900/20 border border-red-200 dark:border-red-800 text-red-700 dark:text-red-300 px-6 py-4 rounded-xl animate-shake">
                  ...
                  <div className="grid gap-6">
                    {aiSuggestions.map((suggestion, index) => {
                      ...
                      return (
                        <div
                          key={suggestion.id}
                          className={`group/suggestion relative p-6 transition-all duration-500 transform hover:scale-[1.02] ${
                            suggestion.applied
                        ...
                        >
                          <div className="absolute inset-0 bg-gradient-to-r from-[var(--color-secondary)]/5 to-[var(--color-primary)]/5 opacity-0 group-hover/suggestion:opacity-100 transition-opacity duration-300"></div>
